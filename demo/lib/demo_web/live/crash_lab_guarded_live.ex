      ...
      <div class="card bg-base-100 shadow-sm border border-base-200">
        <div class="card-body">
          ...
          <p class="text-sm text-base-content/60 mb-4">
            ...
            LiveRescue works independently in each nested LiveView.
          </p>
          ...
          <div class="card bg-base-200/50 border border-base-300">
            <div class="card-body p-4">
              ...
              <p class="text-sm text-base-content/60">
                Visit the dedicated nested LiveView test page to see how LiveRescue
                handles crashes in nested LiveViews (separate processes).
              </p>
              <a href="/guarded/crash/nested" class="btn btn-info btn-sm mt-2">
